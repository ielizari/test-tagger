...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(p) {return ['CONTENT',p]};
  var peg$f2 = function(p) {return p.join('')};
  var peg$f3 = function(p) {return ['DOCBLOCK',p]};
  var peg$f4 = function(p) {return p.join('')};
  var peg$f5 = function(i) {return i};
  var peg$f6 = function(inner) {return inner.join('')};
  ...
  function peg$parsecontent_line() {
    var s0, s1, s2, s3;
